...
public interface RecordDao {
    public int changeRecord(int bid,int status);//取消书的交易 /变成6 
    public List<Record> findRecordsWithParms(Map<String, Object> map);//分页查询交易记录
    public int findRecordsNums(Map<String, Object> map);//查看符合条件的交易的数量
