...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/WEB-INF/css/animate.css" />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/WEB-INF/css/style.css?v=4.1.0" />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/WEB-INF/css/font-awesome.css?v=4.4.0" />
